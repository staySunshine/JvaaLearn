...
- [1、磁盘操作（File）](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#1磁盘操作file)
- [2、字节操作（*Stream）](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#2字节操作stream)
- [3、字符操作（*Reader | *Writer）](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#3字符操作reader--writer)
- 4、Java序列化，如何实现序列化和反序列化，常见的序列化协议有哪些？
  - [Java序列化定义](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#java序列化定义)
  - [如何实现序列化和反序列化，底层怎么实现](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#如何实现序列化和反序列化底层怎么实现)
  - [相关注意事项](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#相关注意事项)
  - [常见的序列化协议有哪些](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#常见的序列化协议有哪些)
- [5、同步和异步](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#5同步和异步)
- 6、Java中的NIO，BIO，AIO分别是什么
  - [BIO](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#bio)
  - [NIO](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#nio)
  - [AIO (NIO.2)](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#aio-nio2)
  - [总结](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#总结)
- [7、BIO，NIO，AIO区别](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#7bionioaio区别)
- [8、Stock通信的伪代码实现流程](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#8stock通信的伪代码实现流程)
- 9、网络操作
  - [InetAddress](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#inetaddress)
  - [URL](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#url)
  - [Sockets](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#sockets)
  - [Datagram](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#datagram)
  - [什么是Socket？](https://github.com/frank-lam/fullstack-tutorial/blob/master/notes/JavaArchitecture/04-Java-IO.md#什么是socket)
...
![image-20200909222709753](04-Java-IO.assets/image-20200909222709753.png)
...
- 若User类仅仅实现了Serializable接口，并且还定义了`readObject(ObjectInputStream in)`

  和`writeObject(ObjectOutputSteam out)`，则采用以下方式进行序列化与反序列化。
...
```java
ObjectInputStream ois= new ObjectInputStream(new javaFileInputStream("object.out"));
```
...
![image-20200910000511018](04-Java-IO.assets/image-20200910000511018.png)
...
![image-20200910001317336](04-Java-IO.assets/image-20200910001317336.png)

为了改进这种一连接一线程的模型，我们可以使用线程池来管理这些线程（需要了解更多请参考前面提供的文章），实现1个或多个线程处理N个客户端的模型（但是底层还是使用的同步阻塞I/O），通常被称为“**伪异步I/O模型**“。

![image-20200910001345897](04-Java-IO.assets/image-20200910001345897.png)
