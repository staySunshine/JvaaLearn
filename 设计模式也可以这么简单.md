...
![1603159325103](设计模式也可以这么简单.assets/1603159325103.png)
...
![1603159371180](设计模式也可以这么简单.assets/1603159371180.png)
...
![1603159398690](设计模式也可以这么简单.assets/1603159398690.png)

当涉及到这种产品族的问题的时候，就需要抽象工厂模式来支持了。我们不再定义 CPU 工厂、主板工厂、硬盘工厂、显示屏工厂等等，我们直接定义电脑工厂，每个电脑工厂负责生产所有的设备，这样能保证肯定不存在兼容问题。

![1603159422708](设计模式也可以这么简单.assets/1603159422708.png)
...
![1603159449883](设计模式也可以这么简单.assets/1603159449883.png)
...
![1603159470659](设计模式也可以这么简单.assets/1603159470659.png)
...
![1603159493331](设计模式也可以这么简单.assets/1603159493331.png)
...
2. 适配器模式和代理模式的异同
   ...
   ![1603159520557](设计模式也可以这么简单.assets/1603159520557.png)
...
![1603159543521](设计模式也可以这么简单.assets/1603159543521.png)
...
![1603159569445](设计模式也可以这么简单.assets/1603159569445.png)
...
![1603159594868](设计模式也可以这么简单.assets/1603159594868.png)

到这里，大家应该已经清楚装饰模式了吧。

下面，我们再来说说 java IO 中的装饰模式。看下图 InputStream 派生出来的部分类：

![1603159621255](设计模式也可以这么简单.assets/1603159621255.png)
...
![1603159644659](设计模式也可以这么简单.assets/1603159644659.png)

这个时候，大家有没有联想到结构型模式中的桥梁模式，它们其实非常相似，我把桥梁模式的图拿过来大家对比下：

![1603159665780](设计模式也可以这么简单.assets/1603159665780.png)
