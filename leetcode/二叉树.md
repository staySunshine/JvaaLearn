...
思路：分治法，左边平衡 && 右边平衡 && 左右两边高度 <= 1， 遍历一遍，如果有左右两边高度 > 1，则不是高度平衡的二叉树。
...
#### binary-tree-level-order-traversal层次应用
...
## [总结](https://wardseptember.gitee.io/mynotes/#/docs/LeetCode/data_structure/binary_tree?id=总结)

- 掌握二叉树递归与非递归遍历
- 理解 DFS 前序遍历与分治法
- 理解 BFS 层次遍历

## [练习](https://wardseptember.gitee.io/mynotes/#/docs/LeetCode/data_structure/binary_tree?id=练习)
